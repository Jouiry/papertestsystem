        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="/assets/img/avatars/2.jpg" alt="avatar" class="mw30 br64">
                    <span class="hidden-xs pl15">${sessionScope.student.stuName}</span>
                    <span class="caret caret-tp hidden-xs"></span>
                </a>
                <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
                    <li class="list-group-item">
                        <a href="/studentself" class="animated animated-short fadeInUp">
                            <span class="fa fa-user"></span> 个人信息
                            <span class="label label-warning"></span>
                        </a>
                    </li>
                    <li class="list-group-item">
                        <a href="/to_change_student_password" class="animated animated-short fadeInUp">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-author">${sessionScope.student.stuName}</div>
