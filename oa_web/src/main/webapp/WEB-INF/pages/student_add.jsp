...
<section id="content" class="table-layout animated fadeIn">
    <div class="tray tray-center">
        ...
        <form action="/student/add" modelAttribute="student"  id="admin-form" name="addForm" method="post" name="addForm">
            <div class="xjhy">
                <!--高级配置-->
                <ul class="hypz gjpz clearfix">
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input class="chang" name="stuId" type="text"/>
                            <i>*</i>
                        </div>
                    </li>
                    <li class="clearfix">
                    ...
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input class="chang" name="stuName" type="text"/>
                        </div>
                    </li>
                    <li class="clearfix">
                    ...
                    <li class="clearfix">
                        ...
                        <div class="li_r">
                            <input class="chang" name="stuPwd" type="text"/>
                        </div>
                    </li>
                    <%--<li class="clearfix">--%>
