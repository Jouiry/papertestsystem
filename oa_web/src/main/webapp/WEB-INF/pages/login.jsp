...
<div class="second_body">
    <form id="myForm"  method="post">
        ...
        <div class="logo"></div>
        <div class="title-zh" style="font-size: large">《大学物理》考试管理信息系统</div>
        <div class="title-en" >College Physics Examination Management System</div>
        <div class="message" data-bind="html:message"></div>
        <table border="0" style="width:300px;">
            <tr>
                <td style="white-space:nowrap; padding-bottom: 5px;width:55px;">用户名：</td>
                <td colspan="2"><input type="text" id="userName" name="id" class="login" data-bind="value:form.userCode" /></td>
            </tr>
            <tr>
                <td class="lable" style="white-space:nowrap; letter-spacing: 0.5em; vertical-align: middle">密码：</td>
                <td colspan="2"><input type="password" id="password" name="password" class="login" data-bind="value:form.password" /></td>
            </tr>
            <tr>
                <td style="white-space:nowrap; padding-bottom: 5px;width:55px;">验证码：</td>
                <td colspan="1" style="width: 140px"><input type="text" id="loginCode" class="login" name="code" style="width: 50px;" />&nbsp;<img src="<%=request.getContextPath() %>/pictureCheckCode" id="CreateCheckCode" align="middle" style="margin-top:-15px;"></td>
        ...
        if(check()){
            ...
            $.ajax({
                ...
                success:function(msg){
                    ...
                    if(msg=="student"){
                        window.location.href="<%=request.getContextPath()%>/studentself";
                    }
                    if(msg=="teacher"){
                        window.location.href="<%=request.getContextPath()%>/teacherself";
                    }
                    if(msg=="admin"){
                        window.location.href="<%=request.getContextPath()%>/adminself";
                    }
                }
            })
        }
